...
function visualize(){
  ...
  bars.append("path")
    .attr("d", arc_zero)
    .attr("stroke", "rgba(221, 179, 181, 0.8)")
  ...
  var title_default = "What I love & What I hate ";
  var title = g.append("text")
      .text(title_default)
      .attr("xml:space", "preserve")
      .attr("text-anchor", "middle")
      .attr("font-family", "GameOfThrones, sans-serif")
      .attr("font-size", size/28+"px")
      .attr("fill", "white");
  
  var subtitle_default = data.length + " aspects about me you will know from here!";
